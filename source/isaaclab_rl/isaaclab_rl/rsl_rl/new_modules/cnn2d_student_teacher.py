...
class CNN2d_StudentTeacher(nn.Module):
    is_recurrent = False
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for in_ch, out_ch, kernel_size, stride, padding, dilation in zip(
            ...
            student_layers.append(nn.Conv2d(
                in_channels=in_ch,
                out_channels=out_ch,
        ...
        student_layers.append(nn.Linear(s_out_h * s_out_w * s_out_channels[-1], student_hidden_dims[0]))
        student_layers.append(activation)
        ...
        print(f"Student CNN2d+MLP: {self.student}")
    ...
    def update_distribution(self, observations):
        observations = observations.reshape(observations.shape[0], self.s_h, self.s_w)
